                            ...
                            return AlertDialog(
                              ...
                              content: SingleChildScrollView(
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text('Mood: $_mood'), // Menampilkan nilai dari variabel _mood
                                    Text('Feelings: $_feelings'), // Menampilkan nilai dari variabel _feelings
                                    Text('Mood Intensity: $_moodIntensity'), // Menampilkan nilai dari variabel _moodIntensity
                                  ],
                                ),
                              ),
                              actions: [
